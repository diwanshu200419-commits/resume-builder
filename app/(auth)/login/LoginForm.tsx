...
export default function LoginForm() {
  ...
  const handleSendOtp = async (e: React.FormEvent) => {
    ...
    if (res?.error) {
      ...
      setOtpSent(true);
      setOtpMessage("OTP sent to " + phone + "! Use test verification code: 123456");
    }
  };
      ...
      <div className="flex-1 flex items-center justify-center p-6 purple-glow">
        <div className="w-full max-w-md">
          <div className="rounded-xl border border-border bg-surface p-8 card-glow">
            <h1 className="text-2xl font-bold text-text-primary mb-1">Welcome to Vaylo AI</h1>
            <p className="text-text-secondary text-sm mb-6">Sign in to access your workspace and AI resume tools</p>
