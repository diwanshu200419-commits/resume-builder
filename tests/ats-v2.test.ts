import { evaluateATSV2, ATS_SCORING_WEIGHTS, normalizeSkill } from "../lib/ats-v2";
...
assert((fresherResult.score_breakdown?.projects.score || 0) > 0, "5b. Awards meaningful project score to fresher");
...
const categorySum = Object.values(runA.score_breakdown || {}).reduce((sum, item: any) => sum + (item.score || 0), 0);
